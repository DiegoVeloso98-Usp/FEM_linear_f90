program main
    ...
    !_    gfortran -fcheck=all -g -fopenmp -ffree-line-length-none sparse_set.f90 main.f90 read_data.f90 hammer.f90 shape.f90 particle_generator.f90 assembly.f90 sigma.f90 particle_displacement.f90 writing_acadview.f90 -o program.out -L. -lsuperlu -lblasslu -llapack -lblas                 ___!
    !========================================================================================================!
    !========================================================================================================!
    ...
    !__________________________________________|= COMPILE COMMAND  =|________________________________________!
    !__________________________________________|====================|________________________________________!
    !_    gfortran -O3 -ffast-math -fopenmp -ffree-line-length-none sparse_set.f90 main.f90 read_data.f90 hammer.f90 shape.f90 particle_generator.f90 assembly.f90 sigma.f90 particle_displacement.f90 writing_acadview.f90 -o program.out -L. -lsuperlu -lblasslu -llapack -lblas            _____!
    !========================================================================================================!
    !========================================================================================================!
